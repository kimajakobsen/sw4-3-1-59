...
*/
public class LayoutVisitor implements IVisitor {
...
*/
  ...
  public Object visitProgram(Program ast, Object obj) {
    return layoutUnary("Program", ast);
  }
...
public Object visitAddop(Addop op, Object arg) {
	return layoutNullary(op.T.spelling);
}

@Override
public Object visitSequantialStatement(SequantialStatement stm, Object arg) {

	return layoutBinary("Seq. Statement", stm.P, stm.D);
}

@Override
public Object visitSingleStatement(SingleStatement singleStatement, Object arg) {
	
	return layoutUnary("Statement", singleStatement.D);
}

@Override
public Object visitDeclaration(Declaration declaration, Object arg) {
	return layoutBinary("Declaration", declaration.V, declaration.E );
}

@Override
public Object visitSequantialExpression(
		SequantialExpression sequantialExpression, Object arg) {
		if(sequantialExpression.O == null){
			System.out.println("O is null");
		}
		if(sequantialExpression.V == null){
			System.out.println("V is null");
		}
		if(sequantialExpression.E == null){
			System.out.println("E is null");
		}
	return layoutTernary("Seq. Expression", sequantialExpression.E, sequantialExpression.O, sequantialExpression.V);
}

@Override
public Object visitIdentifier(ast.Identifier identifier, Object arg) {
	
	return layoutNullary(identifier.T.spelling);
}

@Override
public Object visitSingleExpression(SingleExpression se, Object arg) {
	
	return layoutUnary("Single Expression", se.E);
}

@Override
public Object visitIntLiteral(Intliteral il, Object arg) {
	
	return layoutNullary(il.T.spelling);
}

@Override
public Object visitMultiop(Multiop mo, Object arg) {
	
	return  layoutNullary(mo.T.spelling);
}

@Override
public Object visitParseExpression(ParseExpression pe, Object arg) {
	
	return  layoutUnary("Parse Expression", pe.E);
}
...
public Object visitSecondarySequentialExpression(
	...
	return layoutTernary("Sequentail Secondary Expression", see.P, see.O, see.S);
}
...
public Object visitSecondarySingleExpression(SecondarySingleExpression sse,
	...
	return layoutUnary("Single Sec. Expr.", sse.P);
}

@Override
public Object visitVName(VName v, Object arg) {
	return layoutNullary(v.T.spelling);
}
